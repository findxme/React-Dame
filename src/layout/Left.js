...
class Left extends Component {
    ...
    render() {
        return (<Menu theme="dark" mode="inline" defaultSelectedKeys={['4']}>
            ...
            >
                <Menu.Item key="sub11"><Link to="/Helloworld"> <Icon type="pie-chart" /><apan>卡片</apan></Link></Menu.Item>
                <Menu.Item key="sub12"><Link to="/Helloworld2">柱状图</Link></Menu.Item>
            ...
            >
                ...
                <Menu.Item key="sub29"><Link to="/layout/text/newPage">表格</Link></Menu.Item>
                <Menu.Item key="sub29"><Link to="/layout/text/newPage"></Link></Menu.Item>
            </SubMenu>
        </Menu>);
    }
}
